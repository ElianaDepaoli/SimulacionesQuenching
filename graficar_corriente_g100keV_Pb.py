...
archivo = "/home/eliana/phits/Simulaciones/Quenching_Sevilla/blindaje/fotones_contra_Pb/corriente_0_1cm.output"
archivo2 = "/home/eliana/phits/Simulaciones/Quenching_Sevilla/blindaje/fotones_contra_Pb/corriente_0_5cm.output"
archivo3 = "/home/eliana/phits/Simulaciones/Quenching_Sevilla/blindaje/fotones_contra_Pb/corriente_1_0cm.output"
...
#Integrales ··············
print(corriente_Pb_a_exterior["e-lower"][714:716])
print(corriente_Pb_a_exterior["photon"][714:716])

#gammas ·····
Pb_0_1_cm_gammas_tot_entran = Particle_number_through_geometry(corriente_exterior_a_Pb["e-lower"], corriente_exterior_a_Pb["e-upper"], corriente_exterior_a_Pb["photon"], 1)
...
#electrones ······
Pb_0_1_cm_electrones_tot_salen = Particle_number_through_geometry(corriente_Pb_a_exterior["e-lower"][713:716], corriente_Pb_a_exterior["e-upper"][713:716],  corriente_Pb_a_exterior["electron"][713:716], 1) 
Pb_0_5_cm_electrones_tot_salen = Particle_number_through_geometry(corriente_Pb_a_exterior_0_5["e-lower"][713:716], corriente_Pb_a_exterior_0_5["e-upper"][713:716], corriente_Pb_a_exterior_0_5["electron"][713:716], 1)  
Pb_1_0_cm_electrones_tot_salen = Particle_number_through_geometry(corriente_Pb_a_exterior_1_0["e-lower"][713:716], corriente_Pb_a_exterior_1_0["e-upper"][713:716], corriente_Pb_a_exterior_1_0["electron"][713:716], 1) 
...
#neutrones ···
Pb_0_1_cm_n_tot_salen = Particle_number_through_geometry(corriente_Pb_a_exterior["e-lower"][712:716], corriente_Pb_a_exterior["e-upper"][712:716],  corriente_Pb_a_exterior["neutron"], 1) 
...
print("Nº de fotones que entran por FOTON emitido", round(Pb_0_1_cm_gammas_tot_entran, 5))
#print("Nº de neutrones que salen por FOTON emitido 0.1 cm de Pb", round(Pb_0_1_cm_n_tot_salen,5))
#print("Nº de neutrones que salen por neutron FOTON 0.5 cm de Pb", round(Pb_0_5_cm_n_tot_salen, 5))
#print("Nº de neutrones que salen por neutron FOTON 1.0 cm de Pb", round(Pb_1_0_cm_n_tot_salen,5))

print("Nº de gammas que salen por FOTON emitido 0.1 cm de Pb", round(Pb_0_1_cm_gammas_tot_salen,8))
print("Nº de gammas que salen por FOTON emitido 0.5 cm de Pb", round(Pb_0_5_cm_gammas_tot_salen,8))
print("Nº de gammas que salen por FOTON emitido 1.0 cm de Pb", round(Pb_1_0_cm_gammas_tot_salen,8))

#print("Nº de alfas que salen por FOTON emitido 0.1 cm de Pb", round(Pb_0_1_cm_alfas_tot_salen,8))
#print("Nº de alfas que salen por FOTON emitido 0.5 cm de Pb", round(Pb_0_5_cm_alfas_tot_salen,8))
#print("Nº de alfas que salen por FOTON emitido 1.0 cm de Pb", round(Pb_1_0_cm_alfas_tot_salen,8))

print("Nº de electrones que salen por FOTON emitido 0.1 cm de Pb", round(Pb_0_1_cm_electrones_tot_salen,8))
print("Nº de electrones que salen por FOTON emitido 0.5 cm de Pb", round(Pb_0_5_cm_electrones_tot_salen,8))
print("Nº de electrones que salen por FOTON emitido 1.0 cm de Pb", round(Pb_1_0_cm_electrones_tot_salen,8))

#print("Nº de positrones que salen por FOTON emitido 0.1 cm de Pb", round(Pb_0_1_cm_positrones_tot_salen,8))
#print("Nº de positrones que salen por FOTON emitido 0.5 cm de Pb", round(Pb_0_5_cm_positrones_tot_salen,8))
#print("Nº de positrones que salen por FOTON emitido 1.0 cm de Pb", round(Pb_1_0_cm_positrones_tot_salen,8))
...
title_ylabel = 'Corriente [particulas/MeV/$\gamma_{emitido}$]'
...
#Fotones ··············
axs[0].errorbar(corriente_exterior_a_Pb['e_mean'], corriente_exterior_a_Pb['photon'], [x*y for x, y in zip(corriente_exterior_a_Pb['photon'], corriente_exterior_a_Pb['photonr.err'])], marker = '^' , markersize = 8 , ls = 'None', label =  r'$\gamma_{fuente}$', color = 'darkorange')#
axs[0].errorbar(corriente_Pb_a_exterior_1_0['e_mean'], corriente_Pb_a_exterior_1_0['photon'], [x*y for x, y in zip(corriente_Pb_a_exterior_1_0['photon'], corriente_Pb_a_exterior_1_0['photonr.err'])], marker = 's', ls = 'None', label =  r'$\gamma_{1.0 cm}$', color = 'tab:cyan')#
axs[0].errorbar(corriente_Pb_a_exterior_0_5['e_mean'], corriente_Pb_a_exterior_0_5['photon'], [x*y for x, y in zip(corriente_Pb_a_exterior_0_5['photon'], corriente_Pb_a_exterior_0_5['photonr.err'])], marker = 'v', ls = 'None', label =  r'$\gamma_{0.5 cm}$', color = 'tab:olive')#
axs[0].errorbar(corriente_Pb_a_exterior['e_mean'], corriente_Pb_a_exterior['photon'], [x*y for x, y in zip(corriente_Pb_a_exterior['photon'], corriente_Pb_a_exterior['photonr.err'])], marker = '<' , ls = 'None', label =  r'$\gamma_{0.1 cm}$', color = 'tab:pink')#
axs[0].set_yscale('log')
#axs[0].set_ylim(1e-6, 1e-1)
axs[0].set_xlabel(title_xlabel)
axs[0].set_ylabel(title_ylabel)
axs[0].set_xlim(1e-6, 1.05e-1)
axs[0].legend(loc=2)
#Fuente ·················
#axs[0, 1].errorbar(corriente_exterior_a_Pb['e_mean'], corriente_exterior_a_Pb['neutron'], [x*y for x, y in zip(corriente_exterior_a_Pb['photon'], corriente_exterior_a_Pb['photonr.err'])], marker = '>' , ls = 'None', label =  r'$n_{fuente}$', color = 'tab:orange')# + 'f = '+ f'{fuente_n_tot:1.2}' + ' $n_{t}/n_{e}$'
#axs[0,1].legend(loc=1)
#axs[0,1].set_ylim(1e-3, 2e2)

#Electrones ···············
axs[1].errorbar(corriente_Pb_a_exterior['e_mean'], corriente_Pb_a_exterior['electron'], [x*y for x, y in zip(corriente_Pb_a_exterior['electron'], corriente_Pb_a_exterior['electronr.err'])], marker = '<', ls = 'None', label =  r'$e^{-}_{0.1 cm}$', color = 'tab:pink')#
axs[1].errorbar(corriente_Pb_a_exterior_0_5['e_mean'], corriente_Pb_a_exterior_0_5['electron'], [x*y for x, y in zip(corriente_Pb_a_exterior_0_5['electron'], corriente_Pb_a_exterior_0_5['electronr.err'])], marker = 'v', ls = 'None', label =  r'$e^{-}_{0.5 cm}$', color = 'tab:olive')#
axs[1].errorbar(corriente_Pb_a_exterior_1_0['e_mean'], corriente_Pb_a_exterior_1_0['electron'], [x*y for x, y in zip(corriente_Pb_a_exterior_1_0['electron'], corriente_Pb_a_exterior_1_0['electronr.err'])], marker = 's', ls = 'None', label =  r'$e^{-}_{1.0 cm}$', color = 'tab:cyan')#
axs[1].set_xlabel(title_xlabel)
#axs[1].set_ylim(-1e-6, 4e-4)
axs[1].legend(loc=1)

#for ax in axs.flat:
#	ax.legend(loc=1)#ncol=3

plt.savefig("/home/eliana/phits/Simulaciones/Quenching_Sevilla/g100keV_Pb.png")
plt.show()
...
#neutrones zoom ··············
'''
axs[1,1].errorbar(corriente_Pb_a_exterior_1_0['e_mean'], corriente_Pb_a_exterior_1_0['neutron'], [x*y for x, y in zip(corriente_Pb_a_exterior_1_0['neutron'], corriente_Pb_a_exterior_1_0['neutronr.err'])], marker = 's', ls = 'None', label =  r'$n_{1.0 cm}$', color = 'tab:cyan')#
axs[1,1].errorbar(corriente_Pb_a_exterior_0_5['e_mean'], corriente_Pb_a_exterior_0_5['neutron'], [x*y for x, y in zip(corriente_Pb_a_exterior_0_5['neutron'], corriente_Pb_a_exterior_0_5['neutronr.err'])], marker = 'v', ls = 'None', label =  r'$n_{0.5 cm}$', color = 'tab:olive')#
axs[1,1].errorbar(corriente_Pb_a_exterior['e_mean'], corriente_Pb_a_exterior['neutron'], [x*y for x, y in zip(corriente_Pb_a_exterior['neutron'], corriente_Pb_a_exterior['neutronr.err'])], marker = '<' , ls = 'None', label =  r'$n_{0.1 cm}$', color = 'tab:pink')#
axs[1,1].set_yscale('log')
axs[1,1].set_ylabel(title_ylabel)
axs[1,1].set_xlim(1e-6, 1.5e-1)
axs[1,1].legend(loc=1)
axs[1,1].set_ylim(5e0, 2e1)
'''
